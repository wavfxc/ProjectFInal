...
> _Добавь сюда скриншоты приложения после первого запуска — главный экран, страница деталей, секция заблокированных игр._

| Главный экран | Детали игры | Заблокированные игры |
|---|---|---|
| `screenshot-main.png` | `screenshot-details.png` | `screenshot-blocked.png` |
